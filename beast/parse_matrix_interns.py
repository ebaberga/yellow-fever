...
country_bf_series = pd.Series([ find_bf(series['avg'], n_countries**2-1, n_countries) for column, series in log_data.iteritems() if 'country.indicator' in column ]) #we will then use this to fill our matrices.
